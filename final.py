...
subprocess.run(["docker","service","create","--name","broker","--replicas","3","--restart-condition","any","--network=se443_test_net","--mount","type=bind,source=/Users/sarahalsh/Downloads/MQTT/mosquitto.conf,destination=/mosquitto/config/mosquitto.conf","eclipse-mosquitto:latest"]) 
